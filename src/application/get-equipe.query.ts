...
export function getEquipe(membres: Membre[]): GetEquipeResult {
  return {
    ...
    meta: MetaPageSchema.parse({
      ...
      description: `Le bureau et le staff technique du ${NOM_CLUB}, club de football de ${COMMUNE} : président, vice-présidents, secrétaire, directeur sportif et éducateurs.`,
    }),
  }
}
